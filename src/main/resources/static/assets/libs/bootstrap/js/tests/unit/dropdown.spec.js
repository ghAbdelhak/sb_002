    ...
    it('should create offset modifier correctly when offset option is a function', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
          '  <div class="dropdown-menu">',
          '    <a class="dropdown-item" >Secondary link</a>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should skip disabled element when using keyboard navigation', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <a id="item1" class="dropdown-item" >Another link</a>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should focus next/previous element when using keyboard navigation', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
          '  <div class="dropdown-menu">',
          '    <a id="item1" class="dropdown-item" >A link</a>',
          '    <a id="item2" class="dropdown-item" >Another link</a>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should not open dropdown if escape key was pressed on the toggle', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '      <a class="dropdown-item" >Another link</a>',
          '    </div>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should propagate escape key events if dropdown is closed', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <button class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</button>',
          '    <div class="dropdown-menu">',
          '      <a class="dropdown-item" >Some Item</a>',
          '    </div>',
          '  </div>',
          '</div>'
        ].join('')
