...
describe('Collapse', () => {
  ...
  describe('constructor', () => {
    ...
    it('should allow jquery object in parent config', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a data-bs-toggle="collapse" >Toggle item</a>',
    ...
    it('should find collapse children if they have collapse class too not only data-bs-parent', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="my-collapse">',
          '  <div class="item">',
          '    <a data-bs-toggle="collapse" >Toggle item 1</a>',
          '    <div id="collapse1" class="collapse show">Lorem ipsum 1</div>',
          '  </div>',
          '  <div class="item">',
          '    <a id="triggerCollapse2" data-bs-toggle="collapse" >Toggle item 2</a>',
  ...
  describe('data-api', () => {
    ...
    it('should remove "collapsed" class from target when collapse is shown', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a id="link1" role="button" data-bs-toggle="collapse" class="collapsed"  data-bs-target="#test1"></a>',
          '<a id="link2" role="button" data-bs-toggle="collapse" class="collapsed"  data-bs-target="#test1"></a>',
          '<div id="test1"></div>'
        ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a id="link1" role="button" data-bs-toggle="collapse"  data-bs-target="#test1"></a>',
          '<a id="link2" role="button" data-bs-toggle="collapse"  data-bs-target="#test1"></a>',
    ...
    it('should allow accordion to target multiple elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="accordion">',
          '  <a id="linkTriggerOne" data-bs-toggle="collapse" data-bs-target=".collapseOne"  aria-expanded="false" aria-controls="collapseOne"></a>',
          '  <a id="linkTriggerTwo" data-bs-toggle="collapse" data-bs-target=".collapseTwo"  aria-expanded="false" aria-controls="collapseTwo"></a>',
